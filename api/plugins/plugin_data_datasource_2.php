...
function plugin_data_datasource_2_edit_default_configsetting_data($id)  {
    ...
    if($db_remote->databaseName!="" && $db_remote->databaseName==$数据库名称 && in_array($数据库名称, $databases)) {
        ...
        for($i=0;$i<sizeof($rs_a);$i++) {
            ...
            $Element['USER_PRIV_OTHER']         = $rs_a[$i]['USER_PRIV_OTHER'];
            $Element['USER_PRIV']               = $rs_a[$i]['USER_PRIV'];
            $RS = InsertOrUpdateTableByArray($TableName="data_user",$Element,"USER_ID",0,"Insert");  
            //print_R($RS);
        }
        ...
        for($i=0;$i<sizeof($rs_a);$i++) {
            ...
            $RS = InsertOrUpdateTableByArray($TableName="data_role",$Element,"name",0,"Insert");  
        }
        ...
        for($i=0;$i<sizeof($rs_a);$i++) {
            ...
            $RS = InsertOrUpdateTableByArray($TableName="data_department",$Element,"id",0);  
            //print_R($RS);
        }
        ...
        for($i=0;$i<sizeof($rs_a);$i++) {
            ...
            $RS = InsertOrUpdateTableByArray($TableName="data_xi",$Element,"系部名称",0);  
            //print_R($RS);
        }
        ...
        for($i=0;$i<sizeof($rs_a);$i++) {
            ...
            $RS = InsertOrUpdateTableByArray($TableName="data_zhuanye",$Element,"专业名称",0);  
        }
        ...
        for($i=0;$i<sizeof($rs_a);$i++) {
            ...
            //print_R($Element);
            $RS = InsertOrUpdateTableByArray($TableName="data_banji",$Element,"班级名称",0);  
        }
        ...
        for($i=0;$i<sizeof($rs_a);$i++) {
            ...
            //print_R($Element);
            $RS = InsertOrUpdateTableByArray($TableName="data_dorm_building",$Element,"宿舍楼名称",0);              
        }
        ...
        for($i=0;$i<sizeof($rs_a);$i++) {
            ...
            $Element['楼层数']                  = $rs_a[$i]['楼层数'];
            //print_R($Element);
            $RS = InsertOrUpdateTableByArray($TableName="data_dorm_dorm",$Element,"宿舍房间",0);              
        }
