...
App({
  globalData: {
    ...
    SYSTEM_APPSTORE_ID: "2",//一个学校可以拥有多个微信小程序,这个ID就是微信小程序记录表里面记录的ID
    ...
    MainDataList: "/wechat/wechat.campus_luquyingxin.php?action=maindata",//需要修改:
    MainDataUpdate: "/wechat/wechat.campus_luquyingxin.php?action=update",//需要修改:
    PayMentInterface: "/wechat/wechat.campus_luquyingxin.payment.php",//需要修改:
    PayMentInterface_xuefei: "/wechat/wechat.campus_luquyingxin_xuefei_gaozhong.payment.php",//需要修改:
    PayMentInterface_qita: "/wechat/wechat.campus_luquyingxin_qita_gaozhong.payment.php",//需要修改:
