...
Page({
  ...
  onLoad()            {
    ...
    if (DANDIAN_SYSTEM_QIYEWEIXIN_USER != undefined
      ...
      if(DANDIAN_SYSTEM_QIYEWEIXIN_USERTYPE=="老师"||DANDIAN_SYSTEM_QIYEWEIXIN_USERTYPE=="学生") {
    ...
    wx.request({  //提交表单数据
      ...
      success: function (res) {
        ...
        if (RESULT == "OK") {
          ...
          getApp().globalData.LOGIN_ACCESS_TOKEN = ress['userData']['LOGIN_ACCESS_TOKEN'];
          getApp().globalData.LOGIN_PRIV_NAME = ress['userData']['LOGIN_PRIV_NAME'];
