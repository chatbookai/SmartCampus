...
Page({
  ...
  getUserSessionKey_storage: function (code) {
    ...
    wx.request({
      url: getApp().globalData.SYSTEM_URL + '/wechat/wechat.get.openid.by.code.php',
      method: 'POST',
      data: {
        code: code,
        SYSTEM_RUNNING_SYSTEM: getApp().globalData.SYSTEM_RUNNING_SYSTEM,
        ...
        userinfo: util.base64encode(JSON.stringify(getApp().globalData.userInfo)),
        currentDeviceInfo: util.base64encode(JSON.stringify(currentDeviceInfo)),
      ...
      fail(res) {
          console.log('wechat.get.openid.by.code.php 请求失败')
      }
